...
const Worksection = () => {
        return (
                <div className=' pt-[30px] sm:pt-[70px] md:pt-[170px] lg:pt-[228px] pb-[30px] md:pb-[60px]'>
                        <div className=' container mx-auto px-3'>
                                <h1 className=' text-white font-orbitron font-normal text-3xl md:text-4xl lg:text-5xl leading-[45px] lg:leading-[67.2px] text-center mx-auto pb-4'>How it <span className=' text-[#98BD42] font-bold'>Works</span></h1>
                                <p className=' font-openSans font-normal text-sm md:text-base mx-auto text-center text-[#CCCCCC] max-w-[680px] mb-6'>If you've used ChatGPT, the OpenAl chatbot that has wowed users by writing code and instantly answering complex questions, you've gotten a glimpse into the next frontier in artificial intelligence, as big tech companies are racing to develop the leading Al chatbot.</p>
                                <p className=' font-openSans font-normal text-sm md:text-base mx-auto text-center text-[#CCCCCC]'>If you want to get portfolio exposure to Al companies but don't want to identify individual Al <span className='block'>stocks, you can invest in an Al-focused exchange-traded fund (ETF). AI ETFs provide exposure to a</span> broad range of the best Al companies, eliminating the need to research and choose individual <span className=' block'>stocks on your own.</span></p>
                                <span className=' flex justify-center mt-[-32%] sm:mt-[-26%]  lg:-mt-[17%]'><Circle /></span>
                                <div className=' grid grid-cols-1 lg:grid-cols-3'>
                                        <div className=' flex flex-col items-center justify-center translate-y-[-36%] 2xl:translate-y-[-55%]'>
                                                ...
                                                <span className=' hidden lg:block mb-[14px]'><Linelr /></span>
                                        ...
                                        <div className=' flex flex-col items-center justify-center translate-y-[-23%] 2xl:translate-y-[-23%]'>
                                                <div className=' flex border border-solid border-[#83A339] rounded-full p-[10.51px] shadow-[0_7px_19.3px_0_#98BD4240]'>
                                                        <span className=' bg-[#83A339] rounded-full w-[26px] h-[26px]'></span>
                                                </div>
                                                <span className=' hidden lg:block mb-[14px]'><Linec /></span>
                                        ...
                                        <div className=' flex flex-col items-center justify-center translate-y-[-47%] 2xl:translate-y-[-65%]'>
                                                <div className=' flex border border-solid border-[#83A339] rounded-full p-[10.51px] shadow-[0_7px_19.3px_0_#98BD4240]'>
                                                        <span className=' bg-[#83A339] rounded-full w-[15.1px] h-[15.1px]'></span>
                                                </div>
                                                <span className=' hidden lg:block mb-[14px]'><Linelr /></span>
